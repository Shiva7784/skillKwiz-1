...
export default function LoginSection() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert(
      isSignIn
        ? "Signing in..."
        : `Registration successful as an ${userType}! Please go to the Services tab to complete details.`
    );
  };
        ...
        <div className="bg-white rounded-lg overflow-hidden shadow-xl flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-1/2 bg-[#00418d] p-8 flex items-center">
            <div className="w-full">
              {isSignIn ? (
                <>
                  <h2 className="text-2xl font-bold text-white mb-6">Sign in to Skill Kwiz</h2>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="text-center text-white">
                      ...
                      <div className="flex justify-center space-x-4">
                        <button type="button" className="w-10 h-10 bg-white rounded-full flex items-center justify-center">
                ...
                <>
                  <h2 className="text-2xl font-bold text-white mb-6">Create a Skill Kwiz Account</h2>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-4">
                      <button
                        ...
                        className={`py-2 rounded text-sm ${
                          userType === "employee" ? "bg-[#f73e5d] text-white" : "bg-gray-200 text-gray-800"
                        }`}
                      >
                        Employee
                      </button>
                      <button
                        ...
                        className={`py-2 rounded text-sm ${
                          userType === "employer" ? "bg-[#f73e5d] text-white" : "bg-gray-200 text-gray-800"
                        }`}
                      >
                        Employer
                      </button>
