...
export default function EmployerAssessmentRequest({ onSubmit }: EmployerAssessmentRequestProps) {
    ...
    <div className="text-white">
      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-center mt-8">
          <button
            onClick={onSubmit}
            className="px-20 py-3 rounded bg-gradient-to-r from-[#4ECDC4] to-[#2d8a84] text-white hover:opacity-90 font-medium"
          >
            Submit Request
          </button>
        </div>
