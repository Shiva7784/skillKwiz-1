...
export default function ServicesPage() {
  ...
  const [assessmentRequestSuccess, setAssessmentRequestSuccess] = useState(false);
                ...
                <div className="bg-gradient-to-r from-[#3a4a7b]/90 to-[#9ba3b9]/90 rounded-lg p-8 backdrop-blur-sm">
                  {scheduleSuccess ? (
                    <SuccessMessage
                      ...
                      message="Thank you! Your skill assessment slot has been successfully scheduled. We have sent a confirmation email with all testing center details."
                      buttonText="Back to Dashboard"
                      onContinue={() => setScheduleSuccess(false)}
                    />
                    ...
                    <ScheduleAssessment onSubmit={handleScheduleSuccess} />
                  )}
                </div>
              ) : (
                <>
                      ...
                      <div className="bg-gradient-to-r from-[#3a4a7b]/90 to-[#9ba3b9]/90 rounded-lg p-8 backdrop-blur-sm">
                        {assessmentRequestSuccess ? (
                          <SuccessMessage
                            ...
                            message="Thank you! Your skill assessment request for the specified candidate has been successfully submitted. We will contact you once the assessment is complete."
                            buttonText="Back to Request Form"
                            onContinue={() => setAssessmentRequestSuccess(false)}
                          />
                        ) : employerScreen === "profile" ? (
                          <EmployerProfile />
                        ) : employerScreen === "assessment" ? (
                          <EmployerAssessmentRequest onSubmit={handleAssessmentRequestSuccess} />
                        ) : (
